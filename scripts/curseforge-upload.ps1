# CurseForge Upload Script — Resource Pack (EnchantVenture Pack)
...
#   - build/EnchantVenture_Pack-<version>.zip (run python build_pack.py first)
...
# Build paths
$zipName = "EnchantVenture_Pack-${modVersion}.zip"
